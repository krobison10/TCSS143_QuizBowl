...
public class QuizBowl   {
   public static void main(String[] args) throws FileNotFoundException {
      ...
      System.out.println("What file stores your questions? Hint: 'sample.txt'");
   ...
   */
   public static void fillQuestionBank(Scanner fileIp, ArrayList<Question> qBank)  
   {
      ...
      {
         lineIndex++;
         fileData.add(fileIp.nextLine());
      }
      int fileLength = lineIndex;
      lineIndex = 0;
      for(int i = lineIndex; i < fileLength; i++)
      {
         String current = fileData.get(0);
